...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='../yolov3_spp/cfg/my_yolov3.cfg', help="*.cfg path")
    parser.add_argument('--data', type=str, default='../yolov3_spp/data/my_data.data', help='*.data path')
    parser.add_argument('--hyp', type=str, default='../yolov3_spp/cfg/hyp.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--T', type=int, default=6, help='Time step')
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov3spp-loading_weights_epochs200.pt',
                        help='initial weights path(记得加入文件后缀名.pt)')
