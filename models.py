...
def create_modules(modules_defs: list, img_size):
    ...
    for i, mdef in enumerate(modules_defs):
        ...
        if mdef["type"] == "convolutional" or mdef["type"] == "convolutional-maxpool" :
            ...
            modules.add_module('ConvTranspose2d', layer.ConvTranspose2d(in_channels=output_filters[-1],
                                                                     out_channels=filters,
                                                                     kernel_size=k,
                                                                     stride=stride,
    ...
    def forward_once(self, x, verbose=False):
        ...
        for i, module in enumerate(self.module_list):
            ...
            if name in ["WeightedFeatureFusion", "FeatureConcat"]:  # sum, concat
                ...
                yolo_out.append(module(x.sum(dim=0)))
